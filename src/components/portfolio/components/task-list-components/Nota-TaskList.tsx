      ...
      <div>
        ...
        <Collapsible.Content className="CollapsibleContent">
          <p className="p mt-2">
            ...
            <span className="text-T2 brightness-150">Dez 2022 | </span>O projeto teve seu desenvolvimento iniciado com um back-end simples e básico.
          </p>
          ...
          <p className="p mt-5">
           ...
           <span className="text-T2 brightness-150">Jan 2023 - Mar 2023 | </span>O projeto passou a ser uma API REST, CRUD, com sistema de notificação, desenvolvida com Node.js, Express e Typescript, aplicando testes unitários,
          ...
          <p className="p mt-5">
            ...
            <span className="text-T2 brightness-150">Mai 2023 - Jul 2023 | </span>Nesta atualização, aprimorei testes, adicionei mocks, testes e2e, tratamento de exceções, status code, logging, rate
