                ...
                <Dialog.Content className="DialogContent focus:outline-none  ">
                    ...
                    <Dialog.Description className="Dgrid ">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            <div className="Icon hover:brightness-[3] mb-1">
                            ...
                            {version ? <img className="mb-1" src={`https://img.shields.io/badge/version-${version}-black`} alt={`Version ${version}`}></img> : null}
                            <p className="text-T2 brightness-200 text-sm mb-1">{type} project</p>
