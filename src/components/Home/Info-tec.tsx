                            ...
                            <div className="flex flex-col gap-2">
                                <div>
                                    <a href="https://www.codewars.com/users/Ldragk" target="_blank"
                                        className={buttons + `
                                    n7:w-52 n3:hover:after:right-[3.2rem]
                                     n4:hover:after:right-4
                                     n5:hover:after:right-4
                                     n6:hover:after:right-4
                                     n7:hover:after:right-4 `
                                        } >
                                ...
                                <div>
                                    <a href="https://www.hackerrank.com/lucasvm_ti" target="_blank" title="Ainda não estou usando"
                                        className={buttons + `
                                    n7:w-52 n3:hover:after:right-6
                                     n4:hover:after:right-4
                                     n5:hover:after:right-4
                                     n6:hover:after:right-4
                                     n7:hover:after:right-4 `
