    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        >
          ...
          ">
            <button className="text-black px-4 py-1 bg-BGB rounded-md brightness-[1.2] rounded-md  hover:brightness-200 
                  w-[48%]   
            ...
            <button className="text-black px-4 py-1 bg-BGB rounded-md brightness-[1.2] hover:brightness-200 w-[48%] "
              onClick={whatsapp}
            >
              Whatsapp
            </button>
