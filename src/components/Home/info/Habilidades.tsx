                    ...
                    {Motion(1.0, 0.9,
                        ...
                        >
                            ...
                            {Motion(1.0, 1.6, <p className="PP ">
                                ...
                                {Motion(1.0, 2.4, <p className="PP ">Plataforma de cursos e comunidade de tecnologia na área de segurança e hacker ético.</p>)}
                            </p>)}

                            {Motion(1.0, 1.8, <p className="PP ">
                               Me mantenho informado sobre o mercado de tecnologia, boas práticas de desenvolvimento e arquitetura de software, além de conduta profissional. Participo da comunidade Tech Leads Club.
                                <div className="flex gap-2">
